...
function getAccountBalance() {
    ...
    .then((answer) => {
        ...
        const accountData = getAccount(accountName)
        console.log(chalk.bgBlue(`O saldo de sua conta é de R$${accountData.balance}`))
...
function toWithdraw() {
    ...
    .then((answer) => {
        ...
        .then((answer) => {
            ...
            const amount = answer.toWithdraw
...
function removeAmount(accountName, amount) {
    ...
    if (amount > accountData.balance) {
        console.log(chalk.bgRed('Você não tem esta quantia!'))
        toWithdraw()
        return
    }
